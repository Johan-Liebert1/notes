...
sudo sed -i "s;options ;options console=tty0 console=ttyS0,115000n enforcing=0 ignition.firstboot ignition.platform.id=qemu ;" /mnt/loader/entries/bootc-composefs-1.conf
